...
CSF::createSection( $prefix, array(
	...
	'fields' => array(
		...
		array(
			...
			'options' => array(
				'default'   => esc_html__( 'Default (header + sidebar/topbar)', 'ytrip' ),
				'minimal'   => esc_html__( 'Minimal (compact header)', 'ytrip' ),
				'fullwidth' => esc_html__( 'Fullwidth (no sidebar)', 'ytrip' ),
			),
			'default' => 'default',
		),
		array(
		...
		array(
			...
			'desc'    => esc_html__( 'Choose how to display pagination on archive pages.', 'ytrip' ),
			'options' => array(
				'numbered' => esc_html__( 'Numbered (1, 2, 3...)', 'ytrip' ),
				'loadmore' => esc_html__( 'Load More Button', 'ytrip' ),
...
CSF::createSection( $prefix, array(
	...
	'fields' => array(
		array(
			...
			'desc'    => esc_html__( 'Choose which layout template to use for single tour pages. Applies site-wide with no code edits. Default uses the main single page; Classic/Modern etc. use alternate designs. Hero slider appears when the tour has 2+ images and Hero with Gallery is Slider/Carousel.', 'ytrip' ),
			'options' => array(
				'default_page' => esc_html__( 'Default (single page)', 'ytrip' ),
				'layout_1'     => esc_html__( 'Classic', 'ytrip' ),
				'layout_2'     => esc_html__( 'Modern', 'ytrip' ),
				'layout_3'     => esc_html__( 'Split', 'ytrip' ),
				'layout_4'     => esc_html__( 'Booking', 'ytrip' ),
...
CSF::createSection( $prefix, array(
	...
	'fields' => array(
		array(
			'id'    => 'github_repo',
			'type'  => 'text',
			'title' => esc_html__( 'GitHub Repository', 'ytrip' ),
		),
		array(
			'id'    => 'github_token',
			'type'  => 'text',
			'title' => esc_html__( 'GitHub Token', 'ytrip' ),
		),
		array(
			'id'      => 'debug_mode',
			'type'    => 'switcher',
...
// ============================================================
// SECTION: Permalinks / Slugs
// ============================================================
CSF::createSection( $prefix, array(
    'title'  => esc_html__( 'Permalinks', 'ytrip' ),
    'icon'   => 'fa fa-link',
    'fields' => array(
        array(
            'id'      => 'slug_tour',
            'type'    => 'text',
            'title'   => esc_html__( 'Tour Post Type Slug', 'ytrip' ),
            'desc'    => esc_html__( 'URL structure: yoursite.com/{slug}/tour-name/', 'ytrip' ),
            'default' => 'tours',
        ),
        array(
            'id'      => 'slug_archive',
            'type'    => 'text',
            'title'   => esc_html__( 'Archive Page Slug', 'ytrip' ),
            'desc'    => esc_html__( 'URL structure: yoursite.com/{slug}/', 'ytrip' ),
            'default' => 'tours',
        ),
        array(
            'id'      => 'slug_destination',
            'type'    => 'text',
            'title'   => esc_html__( 'Destination Slug', 'ytrip' ),
            'desc'    => esc_html__( 'URL structure: yoursite.com/{slug}/destination-name/', 'ytrip' ),
            'default' => 'destinations',
        ),
        array(
            'id'      => 'slug_category',
            'type'    => 'text',
            'title'   => esc_html__( 'Category Slug', 'ytrip' ),
            'desc'    => esc_html__( 'URL structure: yoursite.com/{slug}/category-name/', 'ytrip' ),
            'default' => 'categories',
        ),
    ),
) );
...
// ============================================================
CSF::createSection( $prefix, array(
    'title'  => esc_html__( 'Reviews', 'ytrip' ),
    'icon'   => 'fa fa-star',
    'fields' => array(
        array(
            'id'      => 'enable_reviews',
            'type'    => 'switcher',
            'title'   => esc_html__( 'Enable Reviews', 'ytrip' ),
            'desc'    => esc_html__( 'Allow customers to leave reviews and ratings on tours.', 'ytrip' ),
            'default' => true,
        ),
        array(
            'id'      => 'reviews_require_approval',
            'type'    => 'switcher',
            'title'   => esc_html__( 'Require Approval', 'ytrip' ),
            'desc'    => esc_html__( 'Reviews must be approved before appearing publicly.', 'ytrip' ),
            'default' => true,
        ),
        array(
            'id'      => 'reviews_per_page',
            'type'    => 'number',
            'title'   => esc_html__( 'Reviews Per Page', 'ytrip' ),
            'default' => 10,
            'min'     => 5,
            'max'     => 50,
        ),
        array(
            ...
            'type'    => 'switcher',
            'title'   => esc_html__( 'Show Rating Summary', 'ytrip' ),
            'desc'    => esc_html__( 'Display rating breakdown on tour pages.', 'ytrip' ),
            'default' => true,
        ),
    ),
) );
