...
if ( ! class_exists( 'CSF_Setup' ) ) {
  class CSF_Setup {
    ...
    public static function includes() {
      ...
      self::include_plugin_file( 'classes/cpt.class.php' );
      self::include_plugin_file( 'classes/metabox.class.php' );
      self::include_plugin_file( 'classes/meta.class.php' );
      self::include_plugin_file( 'classes/meta-shortcodes.class.php' );
      self::include_plugin_file( 'classes/custom.php' );
    ...
    public static function add_typography_enqueue_styles() {
      ...
      if ( ! empty( self::$webfonts ) ) {
        ...
        if ( ! empty( self::$webfonts['async'] ) ) {
          ...
          // Use local WebFontLoader (bundled in YTrip)
          $webfont_url = defined( 'YTRIP_URL' ) ? YTRIP_URL . 'assets/vendor/webfontloader/webfontloader.min.js' : '//ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js';
          wp_enqueue_script( 'csf-google-web-fonts', esc_url( $webfont_url ), array(), '1.6.26' );
