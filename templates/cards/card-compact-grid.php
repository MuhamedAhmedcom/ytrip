...
<article class="ytrip-card ytrip-card--compact-grid" data-hover="<?php echo esc_attr( $options['card_hover_effect'] ?? 'lift' ); ?>">
    ...
    <button type="button" class="ytrip-card__wishlist ytrip-card__wishlist--sm ytrip-wishlist-btn" data-tour-id="<?php echo esc_attr( $tour_id ); ?>" aria-label="<?php esc_attr_e( 'Add to wishlist', 'ytrip' ); ?>">
