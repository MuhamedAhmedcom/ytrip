...
$group_size_str = class_exists( 'YTrip_Helper' ) ? YTrip_Helper::format_group_size_from_meta( $meta ) : ( is_array( $meta['group_size'] ?? null ) ? ( ( (int) ( $meta['group_size']['min'] ?? 0 ) ) . ' – ' . ( (int) ( $meta['group_size']['max'] ?? 0 ) ) ) : ( (string) ( $meta['group_size'] ?? '' ) ) );
$price_html = '';
